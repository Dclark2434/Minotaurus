...
choice1 = input("You are at the entrance of the labyrinth. Type 'ENTER' to continue.\n").lower()
if choice1 == "enter":
    choice2 = input("As you enter the labyrinth, you see a fork in the path. You see blood and entrails on the path leading to the right. Type 'LEFT' or 'RIGHT' to continue.\n").lower()
    if choice2 == "left":
        choice3 = input("You walk down the left path and see a door. Type 'OPEN' to continue.\n").lower()
        if choice3 == "open":
            print(MINOTAURUSBATTLE)
            choice4 = input("You open the door and see the Minotaurus. Type 'FIGHT' to continue.\n").lower()
            if choice4 == "fight":
                choice5 = input("Which weapon do you choose? Type 'SWORD', 'AXE', 'SPEAR' to continue.\n").lower() # TODO: use dictionary for better readability.
                if choice5 == "spear":
                    print(VICTORY)
